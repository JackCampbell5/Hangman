...
DONE Make sure you dent have to hit a start button to start
DONE Clean up the interface
Make sure it works on most phones small and big screen devices
DONE Make sure you dont have to click next problom to continue
DONE look at the help interface
DONE stop music when you leave the screen
DONE can stop music more than once
DONE maybe a settings menu for music if i get to it

//What i want to do as updates
Score counter
Put icons in the menu's
don't have to check and uncheck you can just check another automatically
...
//Code i am working on is bellow
        //Sound pool informationa at https://www.youtube.com/watch?v=fIWPSni7kUk
        ...
        hangman_Music = soundPool.load(this, R.raw.music_for_hangman, 1);
        ...
        save_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                soundPool.play(hangman_Music, 1, 1, 0, -1, 1);
        ...
        stop_Button.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View v) {
                ...
                //Code i am working on is above


                //Code taht does not need to be edited is bellow
                //
                //
...
//                    music_swich_boolean = true;
//                    hangman_music.start();
//                    switched_Switch = true;
////                    home_Button.setText(Boolean.toString(music_swich_boolean));
////                    Toast.makeText(settings.this, "Go out of settings for changes to be applied", Toast.LENGTH_LONG).show();
//
//                } else {
//                    hangman_music.pause();
//                    music_swich_boolean = false;
//                    switched_Switch = false;
//
//                }
//            }
//        });
  ...
  //Code that does not need to be edited is above
    //
    //
...
//            public void onClick(View v) {
//
//                hangman_music_Stream = soundPool.play(hangman_Music, 1, 1, 0, -1, 1);
//          // soundPool.pause(hangman_music_Stream);
//
//            }
//        });
//        }
...
//    }
     @Override
         ...
         if(keyCode2 == KeyEvent.KEYCODE_POWER) {
        soundPool.autoPause();

         }
       else if(keyCode2 == KeyEvent.KEYCODE_BACK) {
        soundPool.autoPause();

    }else if (keyCode2 == KeyEvent.KEYCODE_ALL_APPS){
           soundPool.autoPause();
         }
...
public class first_level extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (a_selected == false) {
                    if (another_selected == false) {
                        a_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "a";
                        somthing_CLicked_Boolean = true;
                        a_selected = true;
                        another_selected = true;
                    } else {
                        Toast.makeText(first_level.this, "Select only one at a time", Toast.LENGTH_LONG).show();
                    }
                } else if (a_selected == true) {
                    a_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    a_selected = false;
        ...
        b_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (b_selected == false) {
                    if (another_selected == true) {
                        Toast.makeText(first_level.this, "Select only one at a time", Toast.LENGTH_LONG).show();
                    } else if (another_selected == false) {
                        another_selected = true;
                        b_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "b";
                        somthing_CLicked_Boolean = true;
                        b_selected = true;
                    }
                } else if (b_selected == true) {
                    b_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    b_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (c_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        c_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "c";
                        somthing_CLicked_Boolean = true;
                        c_selected = true;
                    }
                } else if (c_selected == true) {
                    c_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    c_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (d_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        d_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "d";
                        somthing_CLicked_Boolean = true;
                        d_selected = true;
                    }
                } else if (d_selected == true) {
                    d_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    d_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (e_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        e_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "e";
                        somthing_CLicked_Boolean = true;
                        e_selected = true;
                    }
                } else if (e_selected == true) {
                    e_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    e_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (f_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        f_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "f";
                        somthing_CLicked_Boolean = true;
                        f_selected = true;
                    }
                } else if (f_selected == true) {
                    f_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    f_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (g_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        g_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "g";
                        somthing_CLicked_Boolean = true;
                        g_selected = true;
                    }
                } else if (g_selected == true) {
                    g_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    g_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (h_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        h_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "h";
                        somthing_CLicked_Boolean = true;
                        h_selected = true;
                    }
                } else if (h_selected == true) {
                    h_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    h_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (i_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        i_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "i";
                        somthing_CLicked_Boolean = true;
                        i_selected = true;
                    }
                } else if (i_selected == true) {
                    i_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    i_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (j_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        j_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "j";
                        somthing_CLicked_Boolean = true;
                        j_selected = true;
                    }
                } else if (j_selected == true) {
                    j_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    j_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (k_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        k_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "k";
                        somthing_CLicked_Boolean = true;
                        k_selected = true;
                    }
                } else if (k_selected == true) {
                    k_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    k_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (l_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        l_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "l";
                        somthing_CLicked_Boolean = true;
                        l_selected = true;
                    }
                } else if (l_selected == true) {
                    l_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    l_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (m_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        m_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "m";
                        somthing_CLicked_Boolean = true;
                        m_selected = true;
                    }
            ...
            public void onClick(View v) {
                if (n_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        n_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "n";
                        somthing_CLicked_Boolean = true;
                        n_selected = true;
                    }
                } else if (n_selected == true) {
                    n_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    n_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (o_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        o_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "o";
                        somthing_CLicked_Boolean = true;
                        o_selected = true;
                    }
                } else if (o_selected == true) {
                    o_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    o_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (p_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        p_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "p";
                        somthing_CLicked_Boolean = true;
                        p_selected = true;
                    }
                } else if (p_selected == true) {
                    p_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    p_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (q_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        q_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "q";
                        somthing_CLicked_Boolean = true;
                        q_selected = true;
                    }
                } else if (q_selected == true) {
                    q_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    q_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (r_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        r_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "r";
                        somthing_CLicked_Boolean = true;
                        r_selected = true;
                    }
            ...
            public void onClick(View v) {
                if (s_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        s_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "s";
                        somthing_CLicked_Boolean = true;
                        s_selected = true;
                    }
            ...
            public void onClick(View v) {
                if (t_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        t_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "t";
                        somthing_CLicked_Boolean = true;
                        t_selected = true;
                    }
            ...
            public void onClick(View v) {
                if (u_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        u_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "u";
                        somthing_CLicked_Boolean = true;
                        u_selected = true;
                    }
                } else if (u_selected == true) {
                    u_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    u_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (v_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        v_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "v";
                        somthing_CLicked_Boolean = true;
                        v_selected = true;
                    }
            ...
            public void onClick(View v) {
                if (w_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        w_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "w";
                        somthing_CLicked_Boolean = true;
                        w_selected = true;
                    }
                } else if (w_selected == true) {
                    w_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    w_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (x_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        x_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "x";
                        somthing_CLicked_Boolean = true;
                        x_selected = true;
                    }
                } else if (x_selected == true) {
                    x_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    x_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (y_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        y_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "y";
                        somthing_CLicked_Boolean = true;
                        y_selected = true;
                    }
                } else if (y_selected == true) {
                    y_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    y_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
            ...
            public void onClick(View v) {
                if (z_selected == false) {
                    if (another_selected == true) {
                        ...
                        another_selected = true;
                        z_Button.setBackgroundColor(getResources().getColor(R.color.selected));
                        user_Clicked = "z";
                        somthing_CLicked_Boolean = true;
                        z_selected = true;
                    }
                } else if (z_selected == true) {
                    z_Button.setBackgroundColor(getResources().getColor(R.color.unselected));
                    z_selected = false;
                    somthing_CLicked_Boolean = false;
                    another_selected = false;
        ...
        guess_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (somthing_CLicked_Boolean == true) {
                    while (clicked_something_Loop == true) {
//                            if (user_Clicked == user_clicked_1) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_2) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_3) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_4) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_5) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_6) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_7) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_8) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_9) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_10) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_11) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_12) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_13) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_14) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_15) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_16) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_17) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_18) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_19) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_20) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_21) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_22) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_23) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_24) {
//                                clicked_same_number = true;
//                            }
//                            if (user_Clicked == user_clicked_25) {
//                                clicked_same_number = true;
//                            }
//
//                            if (clicked_same_number == true) {
//                                Toast.makeText(first_level.this, "You have already selected this letter", Toast.LENGTH_LONG).show();
//                                clicked_same_number = false;
//                                break;
//                            }
//                            how_many_times_clicked = how_many_times_clicked + 1;
//                            if (clicked_same_number == false) {
//                                switch (how_many_times_clicked) {
//
//                                case 1:
//                                    user_clicked_1 = user_Clicked;
//                                    break;
//                                case 2:
//                                    user_clicked_2 = user_Clicked;
//                                    break;
//                                case 3:
//                                    user_clicked_3 = user_Clicked;
//                                    break;
//                                case 4:
//                                    user_clicked_4 = user_Clicked;
//                                    break;
//                                case 5:
//                                    user_clicked_5 = user_Clicked;
//                                    break;
//                                case 6:
//                                    user_clicked_6 = user_Clicked;
//                                    break;
//                                case 7:
//                                    user_clicked_7 = user_Clicked;
//                                    break;
//                                case 8:
//                                    user_clicked_8 = user_Clicked;
//                                    break;
//                                case 9:
//                                    user_clicked_9 = user_Clicked;
//                                    break;
//                                case 10:
//                                    user_clicked_10 = user_Clicked;
//                                    break;
//                                case 11:
//                                    user_clicked_11 = user_Clicked;
//                                    break;
//                                case 12:
//                                    user_clicked_12 = user_Clicked;
//                                    break;
//                                case 13:
//                                    user_clicked_13 = user_Clicked;
//                                    break;
//                                case 14:
//                                    user_clicked_14 = user_Clicked;
//                                    break;
//                                case 15:
//                                    user_clicked_15 = user_Clicked;
//                                    break;
//                                case 16:
//                                    user_clicked_16 = user_Clicked;
//                                    break;
//                                case 17:
//                                    user_clicked_17 = user_Clicked;
//                                    break;
//                                case 18:
//                                    user_clicked_18 = user_Clicked;
//                                    break;
//                                case 19:
//                                    user_clicked_19 = user_Clicked;
//                                    break;
//                                case 20:
//                                    user_clicked_20 = user_Clicked;
//                                    break;
//                                case 21:
//                                    user_clicked_21 = user_Clicked;
//                                    break;
//                                case 22:
//                                    user_clicked_22 = user_Clicked;
//                                    break;
//                                case 23:
//                                    user_clicked_23 = user_Clicked;
//                                    break;
//                                case 24:
//                                    user_clicked_24 = user_Clicked;
//                                    break;
//                                case 25:
//                                    user_clicked_25 = user_Clicked;
//                                    break;
//
//                                }
//
//                            }
    ...
    static void after_letter_Clicked(){
